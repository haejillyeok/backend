...
| [wiki/decisions/2026-06-05-auth-session-login.md](wiki/decisions/2026-06-05-auth-session-login.md) | 계정 ID 기반 가입 겸 로그인 API, opaque session token, best-effort 접속 IP 기록 기준 |
